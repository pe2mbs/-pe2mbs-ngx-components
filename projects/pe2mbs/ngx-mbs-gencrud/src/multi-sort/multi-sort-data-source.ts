...
{ 
    ...
    public _filterData( data: T[] ): T[] 
    {
        // If there is a filter string, filter out data that does not contain it.
        // Each data object is converted to a string using the function defined by filterPredicate.
        // May be overridden for customization.
        this.filteredData = (this.filter == null || this.filter === '') && !this.filters?.length
                              ? data
    ...
    filterPredicate: (data: T, filter: string) => boolean = (data: T, filter: string): boolean => {
        const dataStr = Object.keys(data as unknown as Record<string, any>).reduce((currentTerm: string, key: string) => {
    ...
    sortData: ((data: T[], sort: MdtMultiSort) => T[]) = (data: T[], sort: MdtMultiSort): T[] => {
    ...
    public compareValues(valueA: string | number, valueB: string | number, direction: string) 
    {
