import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Input, OnDestroy, OnInit,
         Optional, ViewEncapsulation, Inject, ElementRef } from '@angular/core';
...
export class MdtMultiSortHeader extends MatSortHeader implements MatSortable, OnDestroy, OnInit 
{
    ...
    constructor( public _intl: MatSortHeaderIntl, changeDetectorRef: ChangeDetectorRef,
                 ...
                 _focusMonitor: FocusMonitor, _elementRef: ElementRef<HTMLElement> ) 
    {
     ...
     */
    public _updateArrowDirection(): void
    {
     ...
     */
    public _getAriaSortAttribute(): "none" | "ascending" | "descending" 
    {
        if ( !this._isSorted() ) 
        {
          return 'none';
