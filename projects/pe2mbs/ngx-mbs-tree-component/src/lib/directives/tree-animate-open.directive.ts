...
export class TreeAnimateOpenDirective 
{
    ...
    @Input( 'treeAnimateOpen' ) set isOpen(value: boolean) 
    {
        if ( value ) 
        {
            this._show();
    ...
    constructor( private renderer: Renderer2, private templateRef: TemplateRef<any>, private viewContainerRef: ViewContainerRef) 
    {
        return;
    }
